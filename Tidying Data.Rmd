...
```{r}
country_gdp <- read_csv("Data Raw/imf-dm-export-20220328.csv")
...
country_gdp <- country_gdp %>% transmute(country = `GDP per capita, current prices (U.S. dollars per capita)`,
 gdp_per_capita = `2010`)
...
tab5 <- full_join(tab4, gdp_country, by = "Entity")
```
